...
$TABLE ID TIME TALD DIALID OCC CL_RES CL_SLED ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7 CLCR CL DV MDV EVID PRED IPRED RES IRES WRES KREA ALB HEIGHT WEIGHT SEX BLOFLOW DIALFLOW ULTRFIL BLOVOL CRCLCG TALD IWRES CWRES NOAPPEND ONEHEADER NOPRINT FILE=sdtab

$TABLE ID TIME TALD CL_RES CL_SLED DV MDV EVID PRED IPRED RES CWRES IRES WRES IWRES CL V ETA1 ETA2 ETA3 ETA4 ETA5 ETA6 ETA7 DIALID AGE DIUR CLCR CRRT KREA ALB HEIGHT WEIGHT SEX BLOFLOW DIALFLOW ULTRFIL BLOVOL CRCLCG TALD FIRSTONLY ONEHEADER NOPRINT FILE=patab
